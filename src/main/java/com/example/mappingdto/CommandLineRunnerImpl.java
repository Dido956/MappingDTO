        ...
        while (true) {
            ...
            switch (commands[0]) {
                ...
                case "DetailGame" -> gameService
                        .getGameDetails(commands[1]);
                case "OwnedGames" -> userService
                        .getAllGamesByLoggedInUser();
                case "AddItem" -> userService
                        .addItemToCart(commands[1]);
//    ToDo      case "RemoveItem" -> userService
//                      .removeItemFromCart(commands[1]);
